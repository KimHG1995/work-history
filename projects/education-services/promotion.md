...
| 항목 | 내용 |
| --- | --- |
| 작업 기간 | 제휴 연계 2025-06-02 시작. 공통 쿠폰 개선 전체 기간 미확인 |
| 맡은 범위 | 쿠폰 템플릿과 이벤트 DB 설계, 서버와 API 개발, 관리자 풀스택 개발 |
| 개발 상태 | 개발 완료 |
| 운영 상태 | 2025-07-28 제휴 연계 운영 배포와 최종 오픈 |
...
| --- | --- |
| 언어 | TypeScript |
| 프론트엔드 | React, Tailwind CSS, Refine, MUI Pro |
| 백엔드 | NestJS, Prisma, Zod |
| 데이터베이스 | MySQL |
| 메시지 발송 | Biztalk, Twilio |
| 파일 처리 | xlsx, CSV 처리 모듈 |

Refine, MUI Pro, Zod와 파일 처리 모듈은 제휴 쿠폰 연계 작업에 사용했습니다.
