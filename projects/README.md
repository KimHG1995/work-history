...
| 작업 | 요약 |
| --- | --- |
| [쿠폰 이벤트 시스템](education-services/promotion.md) | 쿠폰 구조를 템플릿과 이벤트 기반으로 바꾸고, 관리자 풀스택 개발과 서버, DB 설계를 맡았습니다. |
...
| [교육 연동 서비스 서버 전환과 운영 도구 개발](education-services/art-service-renewal.md) | 기존 Java 서버를 동일한 기능 사양으로 전환하고, 인프라와 배포 자동화, 자랑하기 웹과 관리자 페이지를 개발했습니다. |
