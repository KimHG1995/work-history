...
**회사 프로젝트 운영 상태:** 아래 회사 프로젝트는 서비스에 반영하고 실제 운영까지 진행했습니다.
...
| 작업 | 요약 | 상태 |
| --- | --- | --- |
| [HR 계약과 현장 운영 SaaS MVP 개발](hr-saas/mvp.md) | 관리자와 사용자 웹, 서버, DB, 인증, 스토리지와 배포 환경 설계 및 개발 | MVP 완료, 배포 후 제품 흐름 검증 |
