...
| 작업 | 요약 |
| --- | --- |
| [쿠폰 이벤트 시스템](education-services/promotion.md) | 여러 판매처의 구매 정보를 API와 파일 임포트로 연동하고, 템플릿 기반 쿠폰 발급과 관리자 풀스택 개발, 서버와 DB 설계를 맡았습니다. |
...
| [개인 고객 수강 앱 서버](education-services/class-app-server.md) | 선임 개발자의 DB와 아키텍처 설계를 지원하고, 서버 구축과 기존 코드 이관, 수강 데이터와 콘텐츠 마이그레이션을 맡았습니다. |
