# Codex 개발 및 검증 루프 자동화

[AI 개발 품질 자동화 환경](README.md)으로 돌아갑니다.

Codex가 요청 범위를 확인하고 구현한 뒤 변경 범위에 필요한 검사를 선택해 실행하고, 실패를 수정한 후 다시 검증하도록 공통 품질 루프를 구성했습니다.
...
프로젝트별 검사 명령은 분리하면서 요구사항 확인, 구현, 검사 선택, 수정과 재검증이라는 품질 기준은 여러 프로젝트에서 재사용할 수 있게 했습니다.
초기화, 검사 선택, 플러그인 설치와 충돌 방지 동작을 테스트로 검증했습니다.
검증되지 않은 품질 향상률이나 토큰 절감률은 성과로 사용하지 않았습니다.
