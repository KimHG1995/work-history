...
| 항목 | 내용 |
| --- | --- |
| 작업 기간 | 약 1개월. 정확한 시작일과 종료일 미확인 |
| 맡은 범위 | 서버, DB, 관리자 화면 단독 풀스택 개발 |
| 개발 상태 | 개발 완료 |
| 운영 상태 | 운영 반영 완료 |
...
- 결과 재확인: 이용량이 적은 시간대에 크론잡을 실행했다. 처리 결과를 다시 검증하고 응답 실패 건을 처리했다.
...
- 정산과 환불 기능을 내부 관리자 페이지에 반영하고 운영했다.
