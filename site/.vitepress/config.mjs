...
const groupedNames = new Set(['public-education', 'education-services', 'platform-operations', 'hr-saas', 'loglens', 'ai-development-setup']);
const sidebar = [
  ...
  projectGroups.get('platform-operations'),
  {
    text: '사이드 프로젝트',
    collapsed: false,
    items: [projectGroups.get('loglens'), projectGroups.get('hr-saas'), projectGroups.get('ai-development-setup')]
  },
